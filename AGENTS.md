...
- MASSIVIM is a portable NvChad-based Neovim config. NixOS is the primary target; WSL and other non-NixOS setups are supported too. Take care to not break functionality on either system target.
